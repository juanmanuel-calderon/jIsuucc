...
public class GLSLProgramObject {
	...
	public GLSLProgramObject(GL3 gl3, String shadersFilepath, String vertexShader, String fragmentShader) throws Exception {
	...
	public final void attachVertexShader(GL3 gl3, String filename) throws Exception {
	...
	public final void attachFragmentShader(GL3 gl3, String filename) throws Exception {
		URL fileURL = new File(filename).toURI().toURL();
		if (fileURL != null) {
			String content = "";
			BufferedReader input = null;
